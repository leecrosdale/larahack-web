<template>
    <!--Hero-->
    <div class="pt-24 bg-gray-100 text-black">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row justify-center align-content-center items-center">
            <div class="flex flex-col w-full text-center" v-if="event && event.status === 'running'">
                ...
                <div class="w-full">
                    <button class="hover:underline bg-black text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg align">Join the Hackathon</button>
                </div>
            </div>
            ...
            <div class="flex flex-col w-full text-center" v-else>
                ...
                <div class="w-full">
                    <button class="hover:underline bg-black text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg align">Join and get notified!</button>
                </div>
            </div>
