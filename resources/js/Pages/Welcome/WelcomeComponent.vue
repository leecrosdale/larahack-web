<template>
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3" v-if="$page.auth.user === null">
                ...
                <a href="/register" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">Register</a>
            </div>
        </div>
    ...
    <footer>
        <div class="flex text-black justify-center border-t-2">
            <a href="https://crosdale.dev" class="text-gray-700 hover:text-gray-800 m-2  ">
            ...
            <a href="https://twitter.com/leecrosdale" class="text-gray-700 hover:text-gray-800 m-2  ">
            ...
            <a href="https://github.com/larahack-hackathon" class="text-gray-700 hover:text-gray-800 m-2">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
...
<script>
    import WelcomeHeroComponent from "@/Shared/Welcome/WelcomeHeroComponent";
    import WelcomeAboutComponent from "@/Shared/Welcome/WelcomeAboutComponent";
    import StreamComponent from "@/Shared/StreamComponent";
    import SponsorComponent from "@/Shared/SponsorComponent";
    export default {
